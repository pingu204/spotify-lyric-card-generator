...
const Navbar = () => {
    return (<>
        <div className="flex flex-none gap-3 items-center border-b border-b-white/10 h-navbar w-full px-8">
            ...
            <span className="text-sm text-gray-400">Made by <span className="font-bold">Bopie</span> <span className="font-mono">(｡•̀ᴗ-)✧</span></span>
        </div>
    </>)
}
